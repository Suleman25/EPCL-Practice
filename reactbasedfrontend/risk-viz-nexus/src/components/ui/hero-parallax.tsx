...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -20 }}
      key={product.title}
      className="group/product h-60 md:h-96 w-[16rem] md:w-[30rem] relative shrink-0 rounded-xl overflow-hidden"
    >
      ...
      <h2 className="absolute bottom-4 left-4 opacity-0 group-hover/product:opacity-100 text-white font-medium">
        {product.title}
      </h2>
    </motion.div>
  );
